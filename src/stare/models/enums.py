...
class PubnotePhase_1_dataState(StrEnum):
    """Auto-generated enum."""
...
LenientPubnotePhase_1_dataState = _lenient(PubnotePhase_1_dataState)
...
LenientPubnoteStatus = _lenient(PubnoteStatus)
