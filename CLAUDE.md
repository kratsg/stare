...
│   ├── registry.py   # FieldRegistry: load query-fields.toml, normalize, validate
│   ├── errors.py     # DSLError, DSLSyntaxError, DSLValidationError
│   └── _extractor.py # extract_string_fields(), extract_boolean_fields() from OpenAPI schema
├── data/
│   ├── query-grammar.lark  # Lark LALR grammar
│   └── query-fields.toml   # valid field names per mode (generated by extract-fields)
└── models/
